...
export default function ListArticle(props) {
    ...
    return (
        <div className="container" id="list-article">
                    ...
                    {component}
                    <button className="btn btn-success" onClick={prev}>{page.offset - 2}</button>
                    <button className="btn btn-success" onClick={prev}>{page.offset - 1}</button>
                    <button className="btn btn-primary">{page.offset}</button>
                    <button className="btn btn-success" onClick={next}>{page.offset + 1}</button>
                    <button className="btn btn-success" onClick={next}>{page.offset + 2}</button>
